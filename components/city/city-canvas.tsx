...
export interface CityControls { zoom: (factor: number) => void; fit: () => void; rotate?: (angle: number) => void; preset?: (kind: 'overview' | 'neighborhood' | 'street') => void }
